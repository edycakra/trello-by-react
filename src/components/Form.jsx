...
import { useClickOutsideEffect } from "../hooks/hooks";
...
export default function Form(props) {
  ...
  return (
    <FormContainer type={props.type} ref={form}>
      ...
      <ButtonsContainer>
        <Button text={props.buttonText} onClick={handleOnSubmit} />
        {props.onClickCancel && (
...
const FormTextArea = styled.textarea`
  background-color: #fff;
  border-radius: ${(props) =>
    props.formHasHeader ? "0px 0px 3px 3px" : "3px"};
